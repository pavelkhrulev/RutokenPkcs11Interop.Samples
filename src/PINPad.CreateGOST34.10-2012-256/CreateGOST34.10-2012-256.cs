...
namespace PINPad.CreateGOST3410_2012_256
{
    /*************************************************************************
    * Rutoken                                                                *
    ...
    *************************************************************************/
    ...
    {
        // Шаблон для создания открытого ключа ГОСТ Р 34.10-2012(256)
        ...
        // Шаблон для создания закрытого ключа ГОСТ Р 34.10-2012(256)
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                using (var pkcs11 = new Pkcs11(Settings.RutokenEcpDllDefaultPath, Settings.OsLockingDefault))
                {
                    ...
                    Errors.Check("Device in slot 0 is not Rutoken PINPad",
                        tokenInfo.TokenType == RutokenType.PINPAD_FAMILY);

                    // Определение поддерживаемых токеном механизмов
                    Console.WriteLine("Checking mechanisms available");
                    List<CKM> mechanisms = slot.GetMechanismList();
                    Errors.Check(" No mechanisms available", mechanisms.Count > 0);
                    bool isGostR3410Supported =
                        mechanisms.Contains((CKM)Extended_CKM.CKM_GOSTR3410_KEY_PAIR_GEN);
                    bool isGostR3411_2012_256Supported =
                    ...
                    Errors.Check(" CKM_GOSTR3411_12_256 isn`t supported!", isGostR3411_2012_256Supported);
                    ...
                    using (Session session = slot.OpenSession(false))
                    {
                        ...
                        try
                        {
                            ...
                            Console.WriteLine("Generating GOST R 34.10-2012(256) key pair...");
                            var mechanism = new Mechanism((uint)Extended_CKM.CKM_GOSTR3410_KEY_PAIR_GEN);

                            // Сгенерировать ключевую пару ГОСТ Р 34.10-2012(256)
