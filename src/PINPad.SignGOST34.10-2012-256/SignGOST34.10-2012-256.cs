...
namespace PINPad.SignGOST3410_2012_256
{
    /*************************************************************************
    * Rutoken                                                                *
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                using (var pkcs11 = new Pkcs11(Settings.RutokenEcpDllDefaultPath, AppType.MultiThreaded))
                {
                    ...
                    bool isGostR3411_2012_256Supported = mechanisms.Contains((CKM)Extended_CKM.CKM_GOSTR3411_12_256);
                    ...
                    using (Session session = slot.OpenSession(SessionType.ReadWrite))
                    {
                        ...
                        try
                        {
                            ...
                            *************************************************************************/
                            ...
                            // Выполнить подпись запроса на сертификат по алгоритму ГОСТ Р 34.10-2012(256)
                            ...
                            *************************************************************************/
                            ...
                            // Выполнить проверку подписи данных по алгоритму ГОСТ Р 34.10-2012(256)
                            Console.WriteLine("Verifying signature...");
